...
//    public static final int ACTION_SETTING = 3;
    ...
    public static final String APPID = "1105876732";
    public static final String BannerPosID = "2090514970150158";
    public static final String SplashPosID = "9030712940052146";
}
